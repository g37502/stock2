...
from mach_lear.data_proc3 import get_df,get_nump
...
def get_data(file1,file2,file3,file4):
	...
	return nuar,y,nuar_test,y4_test




def fashionmnist(file1, file2, file3, file4):
	nuar, y, nuar_test, y4_test = get_data(file1, file2, file3, file4)
	batchsz = config_h.get_int('mach_lear', 'batch')
