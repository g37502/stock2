...
#
# connstr_140 = "mysql+pymysql://%s:%s@%s:3306/%s?charset=utf8" % (user_140,urlquote(password_140),host_140,db_140)
# print(connstr)
# yconnect_140 = create_engine(connstr_140, echo=True, max_overflow=5)
